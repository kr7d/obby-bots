...
<img src="media/player-run-optimized.gif" width="500" alt="Player recording themselves completing an obby">
...
<img src="media/set-bot.gif" width="500" alt="Player setting starter bot to Slot 1">

**Step 3:** That replay bot spawns and automatically re-runs that recording forever, earning credits on each completed loop.\
<img src="media/bot-run-optimized.gif" width="500" alt="Bot replaying the player's recording">
